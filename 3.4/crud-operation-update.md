...
2. In your database, make all translatable columns either JSON or TEXT. You DO NOT need to cast these columns as array/json/object in the Eloquent model. From Eloquent's perspective they're still strings.
