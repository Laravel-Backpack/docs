...
- [Operations](/docs/{{version}}/crud-operations)
    + [List](/docs/{{version}}/crud-operation-list-entries)
        ...
        + [Editable Columns](/docs/{{version}}/crud-editable-columns)
    ...
    + [Create](/docs/{{version}}/crud-operation-create) & [Update](/docs/{{version}}/crud-operation-update)
        ...
        + [Dataform Modal](/docs/{{version}}/crud-dataform-modal)
...
- [Additional Operations](/docs/{{version}}/crud-operations)
    ...
    + [Calendar](/docs/{{version}}/crud-operation-calendar)
    + [Report](/docs/{{version}}/crud-operation-report)
    + [Download](/docs/{{version}}/crud-operation-download)
- [Official Add-ons](/docs/{{version}}/add-ons-official)
    + [Settings](/docs/{{version}}/add-on-settings)
    + [PermissionManager](/docs/{{version}}/add-on-permission-manager)
    + [TranslationManager](/docs/{{version}}/add-on-translation-manager)
    + [LangFileManager](/docs/{{version}}/add-on-langfile-manager)
    + [Language Switcher](/docs/{{version}}/add-on-language-switcher)
    + [BackupManager](/docs/{{version}}/add-on-backup-manager)
    + [Download Operation](/docs/{{version}}/crud-operation-download)
    + [LogManager](/docs/{{version}}/add-on-log-manager)
    + [PageManager](/docs/{{version}}/add-on-page-manager)
    + [FileManager](/docs/{{version}}/add-on-file-manager)
    + [MenuCRUD](/docs/{{version}}/add-on-menu-crud)
    + [NewsCRUD](/docs/{{version}}/add-on-news-crud)
    + [MediaLibrary Uploaders](/docs/{{version}}/add-on-medialibrary-uploaders)
    + [Activity Log](/docs/{{version}}/add-on-activity-log)
    + [PAN Panel](/docs/{{version}}/add-on-pan-panel)
