...
> IMPORTANT NOTE: Starting with Backpack 4.1, if the _column name_ is the exact same as a relation method in the model, Backpack will assume you're adding a column for that relationship and infer relation attributes from it. To disable this behaviour, you can use `'entity' => false` in your column definition. 
